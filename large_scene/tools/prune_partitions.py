# modified from utils.prune_partitions_v2.py
# fmt: off
# isort: skip_file
import os
import argparse
...
def main():
    ...
    trained_partitions, orientation_transformation = partition_training.get_trained_partitions()
    ...
    with tqdm(trained_partitions) as t:
        for partition_idx, partition_id_str, ckpt_file, bounding_box in t:
            ...
            gaussian_model, outside_part, is_inside = partition_training.split_partition_gaussians(
                ckpt,
                bounding_box,
            )
