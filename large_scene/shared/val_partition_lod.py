# fmt: off
# isort: skip_file
# same as utils/val_partition_lod.py
...
def main():
    ...
    with open(os.path.join(first_partition_dir, config_rel_path), "r") as f:
        full_config = yaml.safe_load(f)
        training_config = full_config["data"]["parser"]["init_args"]
    ...
    output_dir = os.path.join(os.path.dirname(full_config["output"]), "evaluations", "val-{}-{}{}".format(os.path.basename(args.yaml), level_name, "-{}".format(args.val_side) if args.val_side is not None else ""))
