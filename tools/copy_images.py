# from MegaNeRF: https://github.com/cmusatyalab/mega-nerf/blob/main/scripts/copy_images.py
# convert UrbanScene3D dataset to MegaNeRF format
# camera poses for UrbanScene3D dataset should be downloaded before running this script
        ...
        for line in tqdm(f):
            ...
            cv2.imwrite(
                str(
                    ...
                    / "rgbs"
                    / "{}.{}".format(metadata_path.stem, image_name.split(".")[-1])
                ),
                undistorted,
            )
