...
def cli():
    ...
    parser.add_argument("--gsplat", action="store_true", default=False, help="Use gsplat v1 renderer for ply file")
    parser.add_argument(
        "--gsplat_aa", action="store_true", default=False, help="Enable gsplat's anti-aliasing for ply file"
    )
    parser.add_argument(
        "--gsplat_v1_example", action="store_true", default=False, help="Load checkpoint generated by the gsplat repo."
    )
    parser.add_argument(
        "--gsplat_v1_example_aa",
        action="store_true",
        default=False,
        help="Enable anti-aliased for the gsplat repo.'s model",
    )
    parser.add_argument(
        "--seganygs", type=str, default=None, help="Path to a SegAnyGaussian model output directory or checkpoint file"
    )
